...
export function sendTelemetryEvent<P extends IEventNamePropertyMapping, E extends keyof P>(
  ...
  const measures =
    typeof measuresOrDurationMs === 'number' ? { duration: measuresOrDurationMs } : measuresOrDurationMs || undefined;
...
export interface IEventNamePropertyMapping {
  ...
  [EventName.ENVIRONMENT_CHECK_TRIGGER]: {
    trigger: 'run-in-terminal' | 'debug-in-terminal' | 'run-selection' | 'on-workspace-load' | 'as-command' | 'debug';
  };
  /**
